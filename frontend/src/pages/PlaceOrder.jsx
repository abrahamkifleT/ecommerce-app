...
const PlaceOrder = () => {
  ...
  const { navigate, backendUrl, token, cartItems, setCartItem, getCartItems, getCartAmount, delivery_fee, products } = useContext(ShopContext)
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod("razorpay")} className='flex items-center gap-3 border border-gray-300 rounded p-2 px-3 cursor-pointer'>
