  ...
  return (
    <div className='my-10'>
        <div className='text-center py-8 text-3xl'>
             ...
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint iste asperiores est perspiciatis temporibus eligendi deserunt cupiditate illum vero. Error!</p>
        </div> 
