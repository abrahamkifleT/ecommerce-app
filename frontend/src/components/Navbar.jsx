  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          ...
          {/* Drop down Menu */}
          {
            ...
            <div className='group-hover:block hidden absolute dropdown-menu r-0 pt-4'>
              <div className='fle flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
        ...
        <img onClick={() => setVisible(true)} src={assets.menu_icon} alt="" className='w-5 cursor-pointer md:hidden' />
      </div>
